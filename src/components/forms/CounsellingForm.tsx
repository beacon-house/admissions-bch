  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-10 gap-6 mb-6">
        ...
        <div className="bg-white rounded-xl border-2 border-accent/30 shadow-md p-6 flex flex-col md:col-span-6">
          <div className="mb-4">
          ...
          <div className="flex-grow relative rounded-lg overflow-hidden border shadow-sm">
